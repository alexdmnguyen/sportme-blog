    ...
    <main>
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mt-8 text-center p-6">
          <Link href="/articles/esports" className="inline-block bg-indigo-600 text-white font-semibold py-3 px-15 rounded-lg hover:bg-indigo-700 transition-colors shadow-md hover:shadow-lg">
            View eSports Articles
          </Link>
        </div>
      </div>
